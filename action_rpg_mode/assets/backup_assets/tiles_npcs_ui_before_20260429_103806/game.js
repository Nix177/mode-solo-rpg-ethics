...
const ASSET_VERSION = "20260428_regionassets1";
...
const CLASS_DEFS = {
  warrior: {
    ...
    icon: "./assets/profiles/class_warrior.svg",
    baseHp: 150,
    baseAttack: 15,
    baseDefense: 5,
    speed: 165,
  ...
  mage: {
    ...
    icon: "./assets/profiles/class_mage.svg",
    baseHp: 105,
    baseAttack: 18,
    baseDefense: 2,
    speed: 160,
  ...
  hunter: {
    ...
    icon: "./assets/profiles/class_hunter.svg",
    baseHp: 120,
    baseAttack: 16,
    baseDefense: 3,
    speed: 172,
...
const REGION_TILE_IMAGE_PATHS = {
  "village": {
    "floor": [
      ...
      "./assets/region_assets/tiles/village/44_grass_detail_a.png",
      "./assets/region_assets/tiles/village/45_grass_detail_b.png",
      "./assets/region_assets/tiles/village/60_mixed_ground_a.png",
      "./assets/region_assets/tiles/village/61_mixed_ground_b.png",
      "./assets/region_assets/tiles/village/62_mixed_ground_c.png",
      "./assets/region_assets/tiles/village/63_mixed_ground_d.png"
    ],
    "floorAlt": [
      "./assets/region_assets/tiles/village/36_farmland_plain.png",
      "./assets/region_assets/tiles/village/37_farmland_rows.png",
      "./assets/region_assets/tiles/village/38_farmland_watered.png",
      "./assets/region_assets/tiles/village/39_farmland_edge.png",
      "./assets/region_assets/tiles/village/40_hay_patch.png",
      "./assets/region_assets/tiles/village/41_wooden_planks.png",
      "./assets/region_assets/tiles/village/42_worn_ground_a.png",
      "./assets/region_assets/tiles/village/43_worn_ground_b.png"
    ],
    "path": [
      ...
      "./assets/region_assets/tiles/village/12_path_corner_c.png",
      "./assets/region_assets/tiles/village/13_path_corner_d.png",
      "./assets/region_assets/tiles/village/14_path_t.png",
      "./assets/region_assets/tiles/village/15_path_cross.png",
      "./assets/region_assets/tiles/village/20_cobble_a.png",
      "./assets/region_assets/tiles/village/21_cobble_b.png",
      "./assets/region_assets/tiles/village/22_cobble_corner_a.png",
      "./assets/region_assets/tiles/village/23_cobble_edge_a.png",
      "./assets/region_assets/tiles/village/24_plaza_stone_a.png",
      "./assets/region_assets/tiles/village/25_plaza_stone_b.png",
      "./assets/region_assets/tiles/village/26_wood_floor_a.png",
      "./assets/region_assets/tiles/village/27_wood_floor_b.png",
      "./assets/region_assets/tiles/village/48_path_edge_a.png",
      "./assets/region_assets/tiles/village/49_path_edge_b.png",
      "./assets/region_assets/tiles/village/50_path_edge_c.png",
      "./assets/region_assets/tiles/village/51_path_edge_d.png",
      "./assets/region_assets/tiles/village/52_cobble_edge_b.png",
      "./assets/region_assets/tiles/village/53_cobble_edge_c.png",
      "./assets/region_assets/tiles/village/54_cobble_edge_d.png"
    ],
    "wall": [
      "./assets/region_assets/tiles/village/28_fence_horizontal.png",
      "./assets/region_assets/tiles/village/29_fence_vertical.png",
      "./assets/region_assets/tiles/village/30_fence_corner.png",
      "./assets/region_assets/tiles/village/31_fence_gate.png"
    ],
    "water": [
      "./assets/region_assets/tiles/village/00_grass_var_a.png",
      "./assets/region_assets/tiles/village/01_grass_var_b.png",
  ...
  "port": {
    "floor": [
      "./assets/region_assets/tiles/port/14_sand_wet_a.png",
      "./assets/region_assets/tiles/port/15_sand_wet_b.png",
      "./assets/region_assets/tiles/port/34_harbor_stone_a.png",
      "./assets/region_assets/tiles/port/35_harbor_stone_b.png",
      "./assets/region_assets/tiles/port/41_wet_stone_detail.png",
      "./assets/region_assets/tiles/port/42_dock_sand_transition_a.png",
      "./assets/region_assets/tiles/port/43_dock_sand_transition_b.png",
      "./assets/region_assets/tiles/port/44_stone_sand_transition_a.png",
      "./assets/region_assets/tiles/port/50_sand_detail_a.png",
      "./assets/region_assets/tiles/port/51_sand_detail_b.png"
    ],
    "floorAlt": [
      "./assets/region_assets/tiles/port/16_stone_dock_a.png",
      "./assets/region_assets/tiles/port/17_stone_dock_b.png",
      "./assets/region_assets/tiles/port/36_worn_wood_a.png",
      "./assets/region_assets/tiles/port/37_worn_wood_b.png",
      "./assets/region_assets/tiles/port/52_dock_detail_a.png",
      "./assets/region_assets/tiles/port/53_dock_detail_b.png",
      "./assets/region_assets/tiles/port/56_cargo_floor_a.png",
      "./assets/region_assets/tiles/port/57_cargo_floor_b.png"
    ],
    "path": [
      "./assets/region_assets/tiles/port/16_stone_dock_a.png",
      "./assets/region_assets/tiles/port/17_stone_dock_b.png",
      "./assets/region_assets/tiles/port/18_wood_dock_a.png",
      "./assets/region_assets/tiles/port/19_wood_dock_b.png",
      "./assets/region_assets/tiles/port/20_dock_horizontal.png",
      "./assets/region_assets/tiles/port/21_dock_vertical.png",
      "./assets/region_assets/tiles/port/22_dock_corner_a.png",
      "./assets/region_assets/tiles/port/23_dock_corner_b.png",
      "./assets/region_assets/tiles/port/24_dock_edge_water_a.png",
      "./assets/region_assets/tiles/port/25_dock_edge_water_b.png",
      "./assets/region_assets/tiles/port/26_dock_edge_water_c.png",
      "./assets/region_assets/tiles/port/27_dock_edge_water_d.png",
      "./assets/region_assets/tiles/port/28_pier_connection_a.png",
      "./assets/region_assets/tiles/port/29_pier_connection_b.png",
      "./assets/region_assets/tiles/port/34_harbor_stone_a.png",
      "./assets/region_assets/tiles/port/35_harbor_stone_b.png",
      "./assets/region_assets/tiles/port/42_dock_sand_transition_a.png",
      "./assets/region_assets/tiles/port/43_dock_sand_transition_b.png",
    ...
    "water": [
      "./assets/region_assets/tiles/port/00_deep_water_a.png",
      "./assets/region_assets/tiles/port/01_deep_water_b.png",
      "./assets/region_assets/tiles/port/02_deep_water_c.png",
      "./assets/region_assets/tiles/port/03_deep_water_d.png",
      "./assets/region_assets/tiles/port/04_water_anim_a.png",
      "./assets/region_assets/tiles/port/05_water_anim_b.png",
      "./assets/region_assets/tiles/port/06_water_anim_c.png",
      "./assets/region_assets/tiles/port/07_water_anim_d.png",
      "./assets/region_assets/tiles/port/08_shallow_water_a.png",
      "./assets/region_assets/tiles/port/09_shallow_water_b.png"
    ],
    "wall": [
      "./assets/region_assets/tiles/port/16_stone_dock_a.png",
      "./assets/region_assets/tiles/port/17_stone_dock_b.png",
      "./assets/region_assets/tiles/port/32_cargo_detail_a.png",
      "./assets/region_assets/tiles/port/33_cargo_detail_b.png",
      "./assets/region_assets/tiles/port/56_cargo_floor_a.png",
      "./assets/region_assets/tiles/port/57_cargo_floor_b.png"
    ]
  },
  "mine": {
    "floor": [
      "./assets/region_assets/tiles/mine/00_rock_floor_a.png",
      "./assets/region_assets/tiles/mine/01_rock_floor_b.png",
      "./assets/region_assets/tiles/mine/02_rock_floor_c.png",
      "./assets/region_assets/tiles/mine/03_rock_floor_d.png",
      "./assets/region_assets/tiles/mine/08_dirt_gravel_a.png",
      "./assets/region_assets/tiles/mine/09_dirt_gravel_b.png",
      "./assets/region_assets/tiles/mine/56_mine_floor_extra_a.png",
      "./assets/region_assets/tiles/mine/57_mine_floor_extra_b.png",
      "./assets/region_assets/tiles/mine/58_mine_floor_extra_c.png",
      "./assets/region_assets/tiles/mine/59_mine_floor_extra_d.png"
    ],
    "floorAlt": [
      "./assets/region_assets/tiles/mine/04_dark_floor_a.png",
      "./assets/region_assets/tiles/mine/05_dark_floor_b.png",
      "./assets/region_assets/tiles/mine/06_cracked_stone_a.png",
      "./assets/region_assets/tiles/mine/07_cracked_stone_b.png",
      "./assets/region_assets/tiles/mine/38_rock_detail_a.png",
      "./assets/region_assets/tiles/mine/39_rock_detail_b.png",
      "./assets/region_assets/tiles/mine/40_dark_detail_a.png",
      "./assets/region_assets/tiles/mine/41_dark_detail_b.png"
    ],
    "path": [
      "./assets/region_assets/tiles/mine/16_wood_support_floor_a.png",
      "./assets/region_assets/tiles/mine/17_wood_support_floor_b.png",
      "./assets/region_assets/tiles/mine/18_rail_horizontal.png",
      "./assets/region_assets/tiles/mine/19_rail_vertical.png",
      "./assets/region_assets/tiles/mine/20_rail_corner_a.png",
      "./assets/region_assets/tiles/mine/21_rail_corner_b.png",
      "./assets/region_assets/tiles/mine/22_rail_t.png",
      "./assets/region_assets/tiles/mine/23_rail_cross.png",
      "./assets/region_assets/tiles/mine/24_broken_rail_a.png",
      "./assets/region_assets/tiles/mine/25_broken_rail_b.png",
      "./assets/region_assets/tiles/mine/26_wood_plank_path_a.png",
      "./assets/region_assets/tiles/mine/27_wood_plank_path_b.png",
      "./assets/region_assets/tiles/mine/50_rail_detail_a.png",
      "./assets/region_assets/tiles/mine/51_rail_detail_b.png",
      "./assets/region_assets/tiles/mine/52_support_detail_a.png",
      "./assets/region_assets/tiles/mine/53_support_detail_b.png"
    ],
    "wall": [
      "./assets/region_assets/tiles/mine/10_cave_wall_edge_a.png",
      "./assets/region_assets/tiles/mine/11_cave_wall_edge_b.png",
      "./assets/region_assets/tiles/mine/12_cave_wall_corner_a.png",
      "./assets/region_assets/tiles/mine/13_cave_wall_corner_b.png",
      "./assets/region_assets/tiles/mine/14_rough_border_a.png",
      "./assets/region_assets/tiles/mine/15_rough_border_b.png",
      "./assets/region_assets/tiles/mine/60_mine_wall_extra_a.png",
      "./assets/region_assets/tiles/mine/61_mine_wall_extra_b.png",
      "./assets/region_assets/tiles/mine/62_mine_wall_extra_c.png",
      "./assets/region_assets/tiles/mine/63_mine_wall_extra_d.png"
    ],
    "water": [
      "./assets/region_assets/tiles/mine/00_rock_floor_a.png",
      "./assets/region_assets/tiles/mine/01_rock_floor_b.png",
  ...
  "forest": {
    "floor": [
      "./assets/region_assets/tiles/forest/00_lush_grass_a.png",
      "./assets/region_assets/tiles/forest/01_lush_grass_b.png",
      "./assets/region_assets/tiles/forest/02_lush_grass_c.png",
      "./assets/region_assets/tiles/forest/03_lush_grass_d.png",
      "./assets/region_assets/tiles/forest/04_moss_grass_a.png",
      "./assets/region_assets/tiles/forest/05_moss_grass_b.png",
      "./assets/region_assets/tiles/forest/40_forest_detail_a.png",
      "./assets/region_assets/tiles/forest/41_forest_detail_b.png",
      "./assets/region_assets/tiles/forest/42_forest_detail_c.png",
      "./assets/region_assets/tiles/forest/43_forest_detail_d.png",
      "./assets/region_assets/tiles/forest/50_leaf_detail_a.png",
      "./assets/region_assets/tiles/forest/51_leaf_detail_b.png"
    ],
    "floorAlt": [
      "./assets/region_assets/tiles/forest/06_glow_grass_a.png",
      "./assets/region_assets/tiles/forest/07_glow_grass_b.png",
      "./assets/region_assets/tiles/forest/20_mossy_stone_a.png",
      "./assets/region_assets/tiles/forest/21_mossy_stone_b.png",
      "./assets/region_assets/tiles/forest/22_root_ground_a.png",
      "./assets/region_assets/tiles/forest/23_root_ground_b.png",
      "./assets/region_assets/tiles/forest/60_magic_extra_a.png",
      "./assets/region_assets/tiles/forest/61_magic_extra_b.png",
      "./assets/region_assets/tiles/forest/62_magic_extra_c.png",
      "./assets/region_assets/tiles/forest/63_magic_extra_d.png"
    ],
    "path": [
      "./assets/region_assets/tiles/forest/08_forest_path_a.png",
      "./assets/region_assets/tiles/forest/09_forest_path_b.png",
      "./assets/region_assets/tiles/forest/10_path_horizontal.png",
      "./assets/region_assets/tiles/forest/11_path_vertical.png",
      "./assets/region_assets/tiles/forest/12_path_corner_a.png",
      "./assets/region_assets/tiles/forest/13_path_corner_b.png",
      "./assets/region_assets/tiles/forest/14_path_t.png",
      "./assets/region_assets/tiles/forest/15_path_cross.png",
      "./assets/region_assets/tiles/forest/16_grass_path_transition_a.png",
      "./assets/region_assets/tiles/forest/17_grass_path_transition_b.png",
      "./assets/region_assets/tiles/forest/18_grass_path_transition_c.png",
      "./assets/region_assets/tiles/forest/19_grass_path_transition_d.png",
      "./assets/region_assets/tiles/forest/37_path_root_transition_a.png",
      "./assets/region_assets/tiles/forest/52_path_edge_a.png",
      "./assets/region_assets/tiles/forest/53_path_edge_b.png"
    ],
    "water": [
      "./assets/region_assets/tiles/forest/32_magical_puddle.png",
      "./assets/region_assets/tiles/forest/33_enchanted_water_edge_a.png"
    ],
    "wall": [
      "./assets/region_assets/tiles/forest/30_vine_root_edge_a.png",
      "./assets/region_assets/tiles/forest/31_vine_root_edge_b.png",
      "./assets/region_assets/tiles/forest/48_stone_detail_a.png",
      "./assets/region_assets/tiles/forest/49_stone_detail_b.png",
      "./assets/region_assets/tiles/forest/54_moss_edge_a.png",
      "./assets/region_assets/tiles/forest/55_moss_edge_b.png"
    ]
  }
};
...
function decorateRegionWorld(world) {
  ...
  paintPatches(world, "floorAlt", region.type === "village" ? 54 : 96, 3, 7);
  ...
  if (region.type === "village") {
    ...
    paintRect(world, world.width * 0.34, world.height * 0.34, world.width * 0.32, world.height * 0.26, "path");
    paintRoad(world, hub, { x: world.width * 0.84, y: world.height * 0.48 }, 4);
    paintRoad(world, hub, { x: world.width * 0.50, y: world.height * 0.84 }, 4);
    paintRoad(world, hub, { x: world.width * 0.18, y: world.height * 0.52 }, 3);
...
function drawTiles(camX, camY) {
  ...
  for (let ty = startTy; ty <= endTy; ty += 1) {
    for (let tx = startTx; tx <= endTx; tx += 1) {
      ...
      const tilePath = getRegionTilePath(world, type, tx, ty);
...
function applyCharacterChange() {
  if (!state.player || !state.selectedClassId || !state.selectedHeroId) return;
