...
const ASSET_VERSION = "20260428_philo_regions1";
...
const TUTORIAL_STEPS = [
  ...
  { title: "Skill principal", body: "La touche F sert au premier skill de classe, mais il se dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©bloque au niveau 3. Au dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©but, utilise surtout ESPACE et ta barre rapide.", keys: ["KeyF"], label: "Appuie sur F" },
...
function fixText(input) {
  ...
  if (!/[ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡]/.test(input)) {
    return input;
  }
  try {
...
function decorateRegionWorld(world) {
  ...
  paintPatches(world, "floorAlt", region.type === "village" ? 72 : 110, 3, 8);
  buildBoundaries(world);
  for (const portal of region.portals || []) addRegionPortal(world, portal);

  if (region.type === "village") {
    paintRect(world, world.width * 0.28, world.height * 0.30, world.width * 0.44, world.height * 0.38, "path");
    paintRect(world, world.width * 0.08, world.height * 0.08, world.width * 0.16, world.height * 0.18, "floorAlt");
    paintRect(world, world.width * 0.76, world.height * 0.08, world.width * 0.16, world.height * 0.18, "floorAlt");
    addStructure(world, world.width * 0.50, world.height * 0.25, 310, 170, "Maison du conseil", "#5b4630", "#b7791f");
    addStructure(world, world.width * 0.28, world.height * 0.55, 220, 145, "Forge", "#3f4c63", "#67e8f9");
    addStructure(world, world.width * 0.70, world.height * 0.58, 230, 150, "Auberge", "#67523a", "#f59e0b");
    addVillageMaster(world, region);
    createMerchant(world, { x: world.width * 0.32, y: world.height * 0.58 });
    world.walkerZones = [{ x: world.width * 0.52, y: world.height * 0.55, r: 420, type: "default" }];
    world.enemyZones = [
      { x: world.width * 0.12, y: world.height * 0.16 },
      { x: world.width * 0.88, y: world.height * 0.18 },
      { x: world.width * 0.14, y: world.height * 0.86 },
      { x: world.width * 0.88, y: world.height * 0.82 }
    ];
    addRegionalDecor(world, "treeBroad", 22);
    addRegionalDecor(world, "crate", 12);
  } else if (region.type === "mine") {
    world.spawn = { x: world.width * 0.14, y: world.height * 0.52 };
    fillTiles(world, "wall");
    paintRect(world, world.width * 0.08, world.height * 0.18, world.width * 0.78, world.height * 0.62, "floorAlt");
    paintRect(world, world.width * 0.12, world.height * 0.38, world.width * 0.72, world.height * 0.24, "path");
    paintRect(world, world.width * 0.78, world.height * 0.12, world.width * 0.12, world.height * 0.55, "floor");
    addStructure(world, world.width * 0.36, world.height * 0.28, 230, 130, "Bureau du chantier", "#5b4531", "#f97316");
    ...
    world.enemyZones = [{ x: world.width * 0.70, y: world.height * 0.58 }, { x: world.width * 0.80, y: world.height * 0.30 }];
    addRegionalDecor(world, "oreBlue", 18, { x: world.width * 0.48, y: world.height * 0.18, w: world.width * 0.34, h: world.height * 0.58 });
    addRegionalDecor(world, "oreGold", 9, { x: world.width * 0.30, y: world.height * 0.58, w: world.width * 0.42, h: world.height * 0.20 });
    addRegionalDecor(world, "mineCart", 6, { x: world.width * 0.22, y: world.height * 0.38, w: world.width * 0.46, h: world.height * 0.26 });
  } else if (region.type === "forest") {
    world.spawn = { x: world.width * 0.13, y: world.height * 0.50 };
    fillTiles(world, "floor");
    paintPatches(world, "floorAlt", 160, 3, 9);
    paintRect(world, world.width * 0.16, world.height * 0.45, world.width * 0.70, TILE_SIZE * 4, "path");
    paintRect(world, world.width * 0.38, world.height * 0.33, world.width * 0.25, world.height * 0.22, "floorAlt");
    addStructure(world, world.width * 0.54, world.height * 0.30, 250, 150, "Sanctuaire ancien", "#2f4f38", "#86efac");
    addFactionNpcForRegion(world, state.currentScene, region);
    ...
    addRegionalDecor(world, "treeBroad", 52);
    addRegionalDecor(world, "treePine", 34);
    addRegionalDecor(world, "stoneCircle", 8, { x: world.width * 0.36, y: world.height * 0.20, w: world.width * 0.38, h: world.height * 0.42 });
    ...
    paintRect(world, world.width * 0.25, world.height * 0.50, world.width * 0.50, world.height * 0.20, "path");
    paintRect(world, world.width * 0.44, world.height * 0.36, world.width * 0.12, world.height * 0.34, "path");
    addStructure(world, world.width * 0.28, world.height * 0.36, 250, 150, "Entrepot des turbines", "#31445f", "#38bdf8");
    addStructure(world, world.width * 0.70, world.height * 0.42, 230, 140, "Bureau public", "#4b5563", "#93c5fd");
    addFactionNpcForRegion(world, state.currentScene, region);
    world.walkerZones = [{ x: world.width * 0.48, y: world.height * 0.45, r: 360, type: "port" }];
    world.enemyZones = [{ x: world.width * 0.18, y: world.height * 0.78 }, { x: world.width * 0.82, y: world.height * 0.78 }];
    addRegionalDecor(world, "crate", 22, { x: world.width * 0.16, y: world.height * 0.30, w: world.width * 0.68, h: world.height * 0.35 });
    addRegionalDecor(world, "wind", 5, { x: world.width * 0.56, y: world.height * 0.20, w: world.width * 0.34, h: world.height * 0.24 });
    addRegionalDecor(world, "buoy", 8, { x: world.width * 0.10, y: world.height * 0.70, w: world.width * 0.80, h: world.height * 0.22 });
  }
...
function bossNameForWorld(world) {
  const names = { forest: "Gardien du chantier", lab: "Prototype instable", hospital: "Crise logistique", space: "Sentinelle de dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â´me", coast: "Gardien des marÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es", urban: "Chef de patrouille" };
...
function skillMeta(skillKey) {
  ...
  const fallback = skillKey === "skill1" ? "CompÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tence F" : "CompÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tence R";
  return { key: skillKey, label: def?.name || fallback, desc: def?.desc || "CompÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tence de classe.", icon: def?.icon || `./assets/talents/${skillKey === "skill2" ? "special" : "skill1"}.svg`, unlocked: skillKey === "skill1" ? !!p?.unlockedSkills?.skill1 : !!p?.unlockedSkills?.skill2, levelReq: skillKey === "skill1" ? 3 : (def?.levelReq || 3) };
}
...
function assignHotbarSlot(slotIndex, payload) {
  ...
  renderHotbar();
  addNotification(`Raccourci ${slotIndex + 1} mis ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  jour.`, 1.6, "#67f0c8");
}
...
function renderSkillBook() {
  ...
  for (const entry of entries) {
    ...
    const lockText = entry.unlocked ? (entry.count !== undefined ? `Stock: ${entry.count}` : "DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©bloquÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©") : `DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©bloquÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© au niveau ${entry.levelReq}`;
...
function showTutorialStep(index = 0) {
  ...
  DOM.tutorialAction.textContent = step.label;
...
function finishTutorial() {
  ...
  addNotification("Tutoriel termine. Explore, combats, puis parle aux conseillers.", 3.2, "#67f0c8");
}
...
function updateHud() {
  ...
  DOM.hudHero.textContent = `HÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©ros: ${p.heroName}`;
  DOM.hudLevel.innerHTML = `Lvl: <strong>${p.level}</strong>${(p.talentPoints || 0) > 0 ? `<span class="talent-plus" title="Points ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©penser dans le grimoire">+${p.talentPoints}</span>` : ""}`;
...
function useSkill1(now) {
  ...
  if (!p.unlockedSkills?.skill1) {
    addNotification("Skill F verrouillÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©: atteins le niveau 3 pour le dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©bloquer dans le grimoire.", 2.4, "#c084fc");
    return;
  }
  const stats = getEffectiveStats();
...
function useSkill2(now) {
  ...
  if (!p.unlockedSkills || !p.unlockedSkills.skill2) {
    addNotification("Skill R verrouillÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©: dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©bloque le talent spÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©cial dans le grimoire.", 2.2, "#c084fc");
    return;
  }
  const stats = getEffectiveStats();
...
function maybeLevelUp() {
  ...
  if (leveled) {
    ...
    addNotification(`Niveau ${p.level} atteint! ${p.talentPoints} point(s) de talent ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©penser dans le grimoire.`, 3.8, "#ffc857");
    if (unlockedSkill1) addNotification("CompÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tence F dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©bloquÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e! Glisse-la depuis le grimoire vers la barre rapide.", 3.4, "#c084fc");
  }
  renderInventory();
  renderGrimoire();
}
...
function damagePlayer(rawDamage, now) {
  ...
  if (p.hp <= 0) {
    ...
    addNotification("DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©faite temporaire. Repli au camp.", 3.2, "#ff8c8c");
  }
}
...
function drawGate(camX, camY) {
  ...
  if (Math.hypot(state.player.x - gate.x, state.player.y - gate.y) < 90) {
    ...
    ctx.fillText(gate.open ? "[E] Voter et quitter" : "Porte verrouillÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e", x - 24, y - 17);
  }
}
...
function buyPotion() {
  ...
  p.potions += 1;
  playSfx("itemUse", 0.5);
  addNotification("Potion soin achetÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e.", 1.9, "#67f0c8");
  updateHud();
  renderInventory();
}
...
function buyManaPotion() {
  ...
  p.manaPotions += 1;
  playSfx("itemUse", 0.5);
  addNotification("Potion mana achetÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e.", 1.9, "#67f0c8");
  updateHud();
  renderInventory();
}
...
function usePotion() {
  ...
  if (p.hp >= stats.maxHp) { addNotification("Vie dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©jÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  au maximum.", 1.5, "#ffc857"); return; }
  p.potions -= 1;
  p.hp = Math.min(stats.maxHp, p.hp + Math.round(stats.maxHp * 0.45));
  playSfx("itemUse", 0.55);
  addNotification("Potion soin utilisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e.", 1.8, "#67f0c8");
  updateHud();
  renderInventory();
}
...
function useManaPotion() {
  ...
  if (p.mana >= stats.maxMana) { addNotification("Mana dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©jÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  au maximum.", 1.5, "#ffc857"); return; }
  p.manaPotions -= 1;
  p.mana = Math.min(stats.maxMana, p.mana + Math.round(stats.maxMana * 0.55));
  playSfx("itemUse", 0.55);
  addNotification("Potion mana utilisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e.", 1.8, "#67f0c8");
  updateHud();
  renderInventory();
}
...
function advanceToNextScene(preferredTargetId) {
  ...
  if (!nextId) {
    addNotification("Campagne terminÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e. Bravo mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©diateur.", 4, "#67f0c8");
    return;
  }
...
function submitVote() {
  ...
  if (justification.length < 20) {
    addNotification("Justification trop courte (20+ caractÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨res).", 2.4, "#ff8c8c");
    return;
  }
  ...
  closeVotePanel();
  addNotification("Vote enregistrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©. Transition en cours...", 2.8, "#67f0c8");
...
function applyCharacterChange() {
  ...
  DOM.classPanel.classList.add("hidden");
  DOM.startBtn.textContent = "DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©marrer";
  state.paused = false;
  state.overlay = null;
  updateHud();
  renderInventory();
